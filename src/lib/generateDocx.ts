...
// ── Sections 2-5 (Fixed text from template) ──
function buildFixedSections(): Paragraph[] {
  ...
  elements.push(subHeading("2.1.1 Detec\u00e7\u00e3o de Altera\u00e7\u00f5es Estruturais:"));
  elements.push(bodyText(
  ...
  elements.push(subHeading("2.1.2 An\u00e1lise de Cargas Especiais:"));
  elements.push(bodyText(
  ...
  elements.push(subHeading("2.1.3 Suporte \u00e0 Decis\u00e3o (Requalifica\u00e7\u00e3o de TB):"));
  elements.push(bodyText(
  ...
  elements.push(subHeading("2.1.4 Inova\u00e7\u00e3o e Posicionamento Estrat\u00e9gico:"));
  elements.push(bodyText(
  ...
  const shm = [
    ...
    "Fabrica\u00e7\u00e3o e configura\u00e7\u00e3o dos sensores, em parceria com a SoraLab, incluindo ajustes de firmware, filtros digitais e calibra\u00e7\u00e3o eletr\u00f4nica.",
  ...
  const modeling = [
    ...
    "Execu\u00e7\u00e3o de prova de carga com caminh\u00f5es-teste, an\u00e1lise comparativa entre respostas medidas e previstas para calibra\u00e7\u00e3o do sistema fornecido pela contratante.",
